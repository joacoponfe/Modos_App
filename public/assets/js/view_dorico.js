...
const object = {'id_melody_mode':'dorico'};
...
async function updateData() {
    ...
    document.documentElement.style.setProperty('--main-color', main_colors['dorico']);
    document.documentElement.style.setProperty('--main-color-transparent', main_colors_transparent['dorico']);
