...
const object = {'id_melody_mode':'mixolidio'};
...
async function updateData() {
    ...
    document.documentElement.style.setProperty('--main-color', main_colors['mixolidio']);
    document.documentElement.style.setProperty('--main-color-transparent', main_colors_transparent['mixolidio']);
