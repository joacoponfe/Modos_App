...
async function updateData() {
    ...
    document.documentElement.style.setProperty('--main-color', main_colors['locrio']);
    document.documentElement.style.setProperty('--main-color-transparent', main_colors_transparent['locrio']);
